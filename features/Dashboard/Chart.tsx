    ...
    <div className="bg-gray-100">
      ...
      {/* <div className="gap-10 px-5"> */}
        <div className="flex justify-center items-center">
          {/* <div className="bg-[#4d1b7a] flex flex-col px-10 py-7 rounded-lg gap-6">
          ...
          <div className="flex gap-2 md:gap-10 md:px-0 px-20">
            ...
            <div className="flex flex-col items-center gap-4 bg-[#e2dfdf] px-10 py-7 rounded-lg">
              ...
              <h2 className="text-[#4d1b7a] font-bold text-sm">
                $ {budget
                    ? 'error' in budget
                      ? budget.error
        ...
        <div className="flex flex-col md:flex-row md:mt-20">
          ...
          <div className="px-10 mt-10 md:mt-0 md:w-1/2">
